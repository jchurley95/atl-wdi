...
SELECT MIN(gnp) FROM country WHERE region = 'Southern Europe';
9.00;
SELECT name FROM country WHERE gnp=9.00;
...
You can run, but you can''t hide, Carmen.
